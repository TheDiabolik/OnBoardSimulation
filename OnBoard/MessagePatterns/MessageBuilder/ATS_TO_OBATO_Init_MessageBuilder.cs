...
namespace OnBoard
{
    public  class ATS_TO_OBATO_Init_MessageBuilder : MessageBuilder
    {
       

        public override void CreateMessageDS()
        {
            m_message.DS = (UInt32)Enums.Message.DS.ATS_SERVER_TO_OBATO_Init;
        }
        public override void CreateMessageSize()
        {
            m_message.Size = (UInt32)Enums.Message.Size.ATS_SERVER_TO_OBATO_Init;
        }
        public override void CreateMessageID()
        {
            m_message.ID = (UInt32)Enums.Message.ID.ATS_SERVER_TO_OBATO_Init;
        }
